...
describe('Service Tests', () => {
    ...
    describe('Ba10Menu Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(Ba10MenuService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/ba-10-menus';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Ba10Menu', () => {

                let entity: Ba10Menu;
                service.find(123).subscribe((_entity: Ba10Menu) => {
                    entity = _entity;
                });
