...
describe('Service Tests', () => {
    ...
    describe('Ind02Std Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(Ind02StdService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/ind-02-stds';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Ind02Std', () => {

                let entity: Ind02Std;
                service.find(123).subscribe((_entity: Ind02Std) => {
                    entity = _entity;
                });
