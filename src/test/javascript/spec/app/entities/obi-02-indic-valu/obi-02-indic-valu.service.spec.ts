...
describe('Service Tests', () => {
    ...
    describe('Obi02IndicValu Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(Obi02IndicValuService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/obi-02-indic-valus';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Obi02IndicValu', () => {

                let entity: Obi02IndicValu;
                service.find(123).subscribe((_entity: Obi02IndicValu) => {
                    entity = _entity;
                });
