...
public class Ba01UtenteResourceIntTest {
    ...
    private static final String DEFAULT_NMNOME = "AAAAAAAAAA";
    private static final String UPDATED_NMNOME = "BBBBBBBBBB";

    private static final String DEFAULT_CDCOD = "AAAAAAAAAA";
    private static final String UPDATED_CDCOD = "BBBBBBBBBB";
    ...
    public void createBa01Utente() throws Exception {
        ...
        assertThat(testBa01Utente.getNmnome()).isEqualTo(DEFAULT_NMNOME);
        assertThat(testBa01Utente.getCdcod()).isEqualTo(DEFAULT_CDCOD);
    }
    ...
    public void getAllBa01Utentes() throws Exception {
        ...
        restBa01UtenteMockMvc.perform(get("/api/ba-01-utentes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nmnome").value(hasItem(DEFAULT_NMNOME.toString())))
            .andExpect(jsonPath("$.[*].cdcod").value(hasItem(DEFAULT_CDCOD.toString())));
    }
    ...
    public void getBa01Utente() throws Exception {
        ...
        restBa01UtenteMockMvc.perform(get("/api/ba-01-utentes/{id}", ba01Utente.getId()))
            ...
            .andExpect(jsonPath("$.nmnome").value(DEFAULT_NMNOME.toString()))
            .andExpect(jsonPath("$.cdcod").value(DEFAULT_CDCOD.toString()));
    }
    ...
    public void updateBa01Utente() throws Exception {
        ...
        Ba01Utente testBa01Utente = ba01UtenteList.get(ba01UtenteList.size() - 1);
        assertThat(testBa01Utente.getNmnome()).isEqualTo(UPDATED_NMNOME);
        assertThat(testBa01Utente.getCdcod()).isEqualTo(UPDATED_CDCOD);
    }
