...
import { JhipsterSampleApplicationIndicValuModule } from './indic-valu/indic-valu.module';
import { JhipsterSampleApplicationIndicValIntModule } from './indic-val-int/indic-val-int.module';
import { JhipsterSampleApplicationObiettiviModule } from './obiettivi/obiettivi.module';
import { JhipsterSampleApplicationObiettiviIndModule } from './obiettivi-ind/obiettivi-ind.module';
...
@NgModule({
    imports: [
        ...
        JhipsterSampleApplicationIndicValuModule,
        JhipsterSampleApplicationIndicValIntModule,
        JhipsterSampleApplicationObiettiviModule,
        JhipsterSampleApplicationObiettiviIndModule,
