...
public class ObiettiviInd implements Serializable {
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<IndicValInt> obi03IndicValuInters = new HashSet<>();
    ...
    public Set<IndicValInt> getObi03IndicValuInters() {
        return obi03IndicValuInters;
    }

    public ObiettiviInd obi03IndicValuInters(Set<IndicValInt> indicValInts) {
        this.obi03IndicValuInters = indicValInts;
        return this;
    }

    public ObiettiviInd addObi03IndicValuInters(IndicValInt indicValInt) {
        this.obi03IndicValuInters.add(indicValInt);
        indicValInt.setObi01ObiettiviIndic(this);
        return this;
    }

    public ObiettiviInd removeObi03IndicValuInters(IndicValInt indicValInt) {
        this.obi03IndicValuInters.remove(indicValInt);
        indicValInt.setObi01ObiettiviIndic(null);
        return this;
    }

    public void setObi03IndicValuInters(Set<IndicValInt> indicValInts) {
        this.obi03IndicValuInters = indicValInts;
    }
